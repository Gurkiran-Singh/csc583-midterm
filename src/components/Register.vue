    ...
    <div v-if="!this.$store.state.user.displayName">
      <form @submit.prevent="validateBeforeSubmit" id="register" action="/users" method="post">
        <div class="form-group" :class="{'has-error': errors.has('displayName') }" >
          ...
          <p class="text-danger" align="center" v-if="errors.has('displayName')">{{ errors.first('displayName') }}</p>
        </div>
        <div class="form-group" :class="{'has-error': errors.has('username') }" >
          ...
          <p class="text-danger" align="center" v-if="errors.has('username')">{{ errors.first('username') }}</p>
        </div>
        ...
        <div class="form-group" :class="{'has-error': errors.has('passwordConf') }" >
          ...
          <p class="text-danger" align="center" v-if="errors.has('passwordConf')">{{ errors.first('passwordConf') }}</p>
        </div>
